    ...
    <div style="background-color: #cd83ff">
        <div class="container">
            ...
            <div class="jumbotron" style="background-color: #d3b0ff">
                <h1 class="heading_characteristics" style="text-align: center;">LATEST EVENTS</h1>
                <hr />
                <br />
            ...
            <div class="jumbotron" style="background-color: #d3b0ff">
                <h1 class="heading_characteristics" style="text-align: center;">NEWS</h1>
                <hr />
                <br />
                <div class="list-group" style="overflow-y: scroll; max-height: 300px;">
                    <div class="list-group">
            ...
            <div class="jumbotron" style="background-color: #d3b0ff">
                <div class="row">
                    ...
                    <div class="socialmedia_item col-6">
                        <h1 class="socialmedia_header" style="background-color: #cd83ff; width: 340px; text-align: center;">FACEBOOK</h1>
                    ...
                    <!-- Embed Twitter -->
                    <div class="socialmedia_item col-6">
                        <h1 class="socialmedia_header" style="background-color: #cd83ff; width: 348px; text-align: center;">TWITTER</h1>
