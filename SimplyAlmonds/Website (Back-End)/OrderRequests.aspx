                    ...
                    <asp:Repeater ID="orderlist" runat="server">
                        <ItemTemplate>
                            <div class="d-flex w-100 justify-content-between">
                                <asp:LinkButton ID="markOrder" runat="server" class="list-group-item list-group-item-action flex-column align-items-start" OnClick="markModal_Click" CommandArgument='<%#Eval("ID")%>'>
                                    <h5 class="mb-1">Order ID: <%#Eval("ID")%></h5>
                                    <p class="mb-1">User ID: <%#Eval("username")%></p>
                                    <asp:LinkButton runat="server" id="orderDetailsLink" class="list-group-item" CommandArgument='<%#Eval("ID")%>' OnClick="orderDetails_Click">Details</asp:LinkButton>
                                </asp:LinkButton>
                            </div>
                        </ItemTemplate>
                    </asp:Repeater>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <br />
                        Complete Name: John Rieven P. Adante <!-- no data in database, sample only -->
                        <br />
                        E-Mail Address: jrpadante@gmail.com <!-- no data in database, sample only -->
                        <br />
                        Product Ordered: <asp:Label ID="productLabel" runat="server" Text=""></asp:Label>
                        <br />
                        Date of Purchase: <asp:Label ID="dateLabel" runat="server" Text=""></asp:Label>
                        <br />
                        Status: <asp:Label ID="statusLabel" runat="server" Text="" ForeColor="#3366FF"></asp:Label>
                    </div>
                    <div class="modal-footer">
