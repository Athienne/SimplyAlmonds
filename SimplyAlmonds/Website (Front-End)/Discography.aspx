                        ...
                        <ItemTemplate>
                            <div class="col">
                                <div class="card mb-4 shadow-sm">
                                    <asp:Image ID="songImg" runat="server" ImageUrl='<%# String.Format("~/Pictures/{0}", Eval("songPicture")) %>' Style="height: auto; width: 100%;" />
                                    <div class="card-body">
                                        <h1 class="card-title pricing-card-title">
                                            ...
                                            <ul class="list-unstyled mt-3 mb-4">
                                                <li>
                                                    <asp:Label ID="lblSongInfo" runat="server" CssClass="ellipsis" Text='<%# Eval("songInfo") %>' Font-Size="Medium"></asp:Label>
                                                    <br />
                                                    <a href='<%# Eval("songSpotify") %>' target="_blank">
                                                        <svg width="20px" height="20px" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
